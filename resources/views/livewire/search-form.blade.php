<div>
    <form method="GET" action="{{ route('listings.index', ['city' => 0]) }}" class="bg-secondary-200 p-1 rounded">
        <div class="grid grid-cols-1 lg:grid-cols-8 gap-1">
            <div class="lg:col-span-3">
                <div>
                    <div class="relative">
                        <input wire:model.live.debounce.300ms="search" type="text" spellcheck="false" autocomplete="off" placeholder="Search by city, state or country" class="w-full rounded-md border-0 bg-white py-1.5 pl-6 pr-12 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-lg sm:leading-10" role="combobox" aria-controls="options" aria-expanded="false">
