    ...
    @if(Route::currentRouteName() == 'home')
        <div class="mt-12 mb-8 grid grid-cols-1 md:grid-cols-2 gap-y-12">
            <div class="flex flex-col justify-center">
                ...
                <p class="mt-6 text-lg font-serif text-gray-600 leading-tight">Whether you're relocating for work or study, or you're a digital nomad in search of your next destination, finding a place that feels like home has never been easier.</p>
            </div>
